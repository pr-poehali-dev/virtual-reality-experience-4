...
const steps = [
  {
    ...
    title: "Знакомство",
    description:
      "Общаемся онлайн или по телефону. Узнаю о вас, вашем стиле, образе жизни — чтобы понять, какой должна быть ваша одежда.",
  },
  {
    number: "02",
    title: "Концепция",
    description:
      "Вместе выбираем ткань, обсуждаем силуэт и детали. Я делаю эскиз и рассказываю, как всё будет выглядеть на вас.",
  },
  {
    number: "03",
    title: "Пошив",
    description:
      "Приступаю к работе в студии. Шью вручную, с вниманием к каждому шву. Промежуточная примерка фиксирует посадку.",
  },
  {
    number: "04",
    title: "Финальная примерка",
    description:
      "Примеряете готовое изделие. Если нужно — вношу последние правки. Результат должен сидеть идеально и радовать вас.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Путь
                <span className="italic"> к изделию</span>
              </h2>
              <p
              ...
              >
                Хорошая одежда не шьётся второпях. Я уделяю время каждому этапу — от знакомства до финальной примерки.
              </p>
            </div>
          </div>
