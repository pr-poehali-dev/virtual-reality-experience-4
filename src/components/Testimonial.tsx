  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Я заказала пальто и не ожидала, что это будет такой осознанный процесс. Мастер слушала, подбирала, примеряла — и результат превзошёл все ожидания. Наконец-то вещь, которая ощущается как моя.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">Постоянная клиентка студии</p>
        </div>
      </div>
    </section>
  )
