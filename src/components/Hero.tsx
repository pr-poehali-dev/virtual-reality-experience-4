  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Одежда,
          <span className="block text-sage">рождённая руками</span>
        </h1>
        ...
        >
          Каждое изделие создаётся вручную в небольшой студии. Никакого масс-маркета — только авторский крой, натуральные ткани и характер.
        </p>
